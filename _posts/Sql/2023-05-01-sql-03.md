...
**🎯 목표**
<br>SQL 실습을 위해 MySQL(DBMS) 설치를 진행한다. 여러 버전 중 무료 버전인 MySQL Community 서버를 설치한다. 또한 MySQL 서버에 GUI 환경으로 접속할 수 있는 MySQL Workbench를 설치하고 서버 접속방법을 알아본다.
{: .notice}
...
<div style="text-align : center;">
<img src="/assets/images/sql/mysql/mysql_4.png" width="60%">
</div>
...
위와 같은 순서대로 설치 프로그램을 열면 이전과는 다른 알림이 뜰 것이다.(Fig 6의 왼쪽 이미지) 그리고 개발자의 macOS에서 확인할 수 없습니다. 열겠습니까? 라는 알림에 '열기'를 클릭하면 설치 프로그램으로 넘어가게 되고(Fig 6의 오른쪽 이미지) '허용'을 클릭하면 MySQL을 설치를 할 수 있는 과정으로 넘어가게 된다.

<div style="text-align : center;">
<img src="/assets/images/sql/mysql/mysql_6.png">
</div>
