...
# 3. RFM 기준 선정
RFM 분석을 진행하기 전, 세 유형의 기준을 정했다. 기준은 아래와 같은 이유로 선정하였다. (모든 고객에 대하여 최근성, 행동 빈도, 구매 금액을 수치화할 수 있으나 극단적, 간단한 방법으로 RFM 분석을 진행하는 것을 목표로 설정)
...
![img5](/assets/images/US_E_Commerce/rfm_sample_10.png){: .align-center width="45%"}
...
![img6](/assets/images/US_E_Commerce/rfm_groupby.png){: .align-center width="40%"}
